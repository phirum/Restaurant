Meteor.startup(function () {
    ...
    categories.forEach(function (c) {
        ...
        var productCount = Restaurant.Collection.Products.find({categoryId: c._id}).count();
...
/*
 ...
 //    return zip.file('category.json', restaurant);
 //};
 ...
 //};
 //categories.forEach(function (c) {
 //    restaurant.categories.push(c);
 //});
 //subCategories.forEach(function (s) {
 //    restaurant.subCategories.push(s);
 //});
 //exportToCsv();
 ...
 var row = 3;
 Restaurant.Collection.Categories.find({}).forEach(function (cat) {
