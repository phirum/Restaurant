...
/*Restaurant.Collection.Sales.before.insert(function(userId,doc){
 var todayDate = moment().format('YYYYMMDD');
 var prefix = doc.branchId + "-" + todayDate;
 doc._id= idGenerator.genWithPrefix(Restaurant.Collection.Sales, prefix, 4);
 });*/



//SaleDetail
/*Restaurant.Collection.Sales.after.insert(function (userId, doc) {
 ...
 Restaurant.Collection.Sales.direct.update(doc._id, {$set: set});
 });
 });*/
