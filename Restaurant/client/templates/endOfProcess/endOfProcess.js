function getStockList(qty,products,branches) {
     products = Restaurant.Collection.Products.find();
     branches = Cpanel.Collection.Branch.find();
    var stockList = [];
    branches.forEach(function (b) {
        products.forEach(function (p) {
            var stock = Restaurant.Collection.Stocks.findOne({productId: p._id, branchId: b._id});
...
Template.restaurant_endOfProcess.events({
