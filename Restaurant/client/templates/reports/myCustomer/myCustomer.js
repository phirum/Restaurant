/*
Template.restaurant_myCustomerReport.onRendered(function () {
    var name = $('[name="date"]');
...
// }
Template.restaurant_myCustomerReport.events({
    ...
    'click #btn-backup': function () {
        var collections = ['Restaurant.Collection.Categories', 'Restaurant.Collection.SubCategories'];
...
Template.restaurant_myCustomerReport.helpers({});
//client only code
