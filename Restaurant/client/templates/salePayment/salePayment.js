var restaurantSalePaymentTPL = Template.restaurant_salePayment;
var restaurantSalePaymentInsertTPL = Template.restaurant_salePaymentInsert;
var restaurantSalePaymentUpdateTPL = Template.restaurant_salePaymentUpdate;
var restaurantSalePaymentShowTPL = Template.restaurant_salePaymentShow;

restaurantSalePaymentTPL.onRendered(function () {
...
restaurantSalePaymentTPL.events({
    ...
    'click .show': function (e, t) {
        alertify.salePaymentShow(fa('eye', 'Payment Detail'), renderTemplate(restaurantSalePaymentShowTPL, this));
    }
});
restaurantSalePaymentInsertTPL.onRendered(function () {
    datePicker();
});
...
restaurantSalePaymentInsertTPL.events({
...
restaurantSalePaymentUpdateTPL.onRendered(function () {
    datePicker();
});
restaurantSalePaymentUpdateTPL.events({
